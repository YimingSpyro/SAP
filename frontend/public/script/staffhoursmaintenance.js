...
async function inputValidation(type) {
    ...
    if (type == "create") {
        ...
        if (description_check.test(create_description)) {
            throw "Only alphanumeric characters, commas and spaces allowed for description."
        }
        if (description_check.test(create_remarks)) {
            throw "Only alphanumeric characters, commas and spaces allowed for remarks."
        }
    }
    if (type == "update") {
